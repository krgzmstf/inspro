...
export const MENU_KATALOG: MenuOge[] = [
  ...
  { href: "/panel/pozlar?lib=kut1", label: "POZ-KÜT-1", icon: "📙" },
  { href: "/panel/pozlar?lib=kut2", label: "Genel Poz Küt-2", icon: "📚" },
  { href: "/panel/pozlar?lib=kut3", label: "Küt-3 (Özelim)", icon: "📗" },
